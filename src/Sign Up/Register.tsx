...
const Register = (props: Props) => {
  ...
  React.useEffect(() => {
    if (!hasRun.current) {
      showToast({
        message: "This Registerform is a demo.",
        type: "info",
        header: "Fake Formular!",
        duration: 6000,
      });
      hasRun.current = true;
    }
        ...
        >
          ...
          <div className="mx-auto mt-10  w-full">
            <button
              ...
              onClick={() =>
                showToast({
                  message: "Register is a demo!",
                  type: "info",
                  header: "Register with X",
                  duration: 6000,
                })
              }
            >
          ...
          <Divider text="or" />
          <h2 className="text-xl font-medium mt-4 cursor-default">
            Enter details to create you'r Account
          </h2>
