    ...
    <div className="bg-gradient-to-tr cursor-default from-slate-200 to-sky-300 h-full pl-16">
      <ValidationProvider>
        ...
        >
          ...
          <h2 className="text-xl font-medium mt-4 cursor-default">Enter Account details to log in</h2>
          ...
          <div className="flex flex-row">
            <CheckboxInput checkboxText={"Remember Password"} validationType="notFalse" />
            <a href="/" className="ml-auto">
              <h3 className="cursor-pointer text-sky-700 text-sm mt-1">Forgot Password?</h3>
            </a>
          </div>
